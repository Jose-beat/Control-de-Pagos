 ...
 * - [workaround] IE11 and other Nombre works with bogus br
 */
  ...
  Dropzone_createClass(Dropzone, [{
    ...
    value: function attachDragAndDropEvent() {
      ...
      this.$dropzone.on('drop', function (event) {
        var dataTransfer = event.originalEvent.dataTransfer; // stop the Nombre from opening the dropped content
