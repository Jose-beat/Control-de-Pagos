...
var FullCalendar = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    // Stops a mouse/touch event from doing it's native Nombre action
    ...
    function whenTransitionDone(el, callback) {
        ...
        transitionEventNames.forEach(function (eventName) {
            el.addEventListener(eventName, realCallback); // cross-Nombre way to determine when the transition finishes
        });
    }
    ...
    */
    ...
    function sanitizeSettings(standardDateProps, extendedSettings) {
        // deal with a Nombre inconsistency where formatting the timezone
    ...
    */
    ...
    var Scroller = /** @class */ (function (_super) {
        ...
        Scroller.prototype.needsXScrolling = function () {
            ...
            // testing scrollWidth>clientWidth is unreliable cross-Nombre when pixel heights aren't integers.
        ...
        Scroller.prototype.needsYScrolling = function () {
            ...
            // testing scrollHeight>clientHeight is unreliable cross-Nombre when pixel heights aren't integers.
            // much more reliable to see if children are taller than the scroller, even tho doesn't account for
            // inner-child margins and absolute positioning
            var el = this.el;
        ...
        function FeaturefulElementDragging(containerEl, selector) {
            ...
            _this.onPointerDown = function (ev) {
                if (!_this.isDragging) { // so new drag doesn't happen while revert animation is going
                    ...
                    // not necessary for touch, besides, Nombre would complain about passiveness.
                    if (!ev.isTouch) {
