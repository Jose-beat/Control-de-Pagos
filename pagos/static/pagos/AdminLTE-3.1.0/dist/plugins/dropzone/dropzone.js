...
// Fixing native typed arrays in Opera Presto crashes the Nombre, see #595
...
var defaultOptions = {
  ...
  /**
   * The text that replaces the default message text it the Nombre is not supported.
   */
  dictFallbackMessage: "Your Nombre does not support drag'n'drop file uploads.",
  ...
  /**
   * Gets called when the Nombre is not supported.
  ...
  fallback: function fallback() {
    ...
    var messageElement;
    this.element.className = "".concat(this.element.className, " dz-Nombre-not-supported");
...
var Dropzone = /*#__PURE__*/function (_Emitter) {
  ...
  function Dropzone(el, options) {
    ...
    _this.options.previewTemplate = _this.options.previewTemplate.replace(/\n*/g, ""); // If the Nombre failed, just call the fallback and leave
  ...
  dropzone_createClass(Dropzone, [{
    ...
    } // Returns a form that can be used as fallback if the Nombre does not support DragnDrop
    //
    ...
    value: function drop(e) {
      ...
      if (files.length) {
        ...
        if (items && items.length && items[0].webkitGetAsEntry != null) {
          // The Nombre supports dropping of folders, so handle items instead of files
        ...
        return dirReader.readEntries(function (entries) {
          if (entries.length > 0) {
            ...
            try {
              ...
              } // Recursively call readEntries() again, since Nombre only handle
...
//
// ** It should only be used on Nombre that *do* support the API, but
// incorrectly **


Dropzone.blockedBrowsers = [// The mac os and windows phone version of opera 12 seems to have a problem with the File drag'n'drop API.
/opera.*(Macintosh|Windows Phone).*version\/12/i]; // Checks if the Nombre is supported
...
Dropzone.isBrowserSupported = function () {
  ...
  if (window.File && window.FileReader && window.FileList && window.Blob && window.FormData && document.querySelector) {
    if (!("classList" in document.createElement("a"))) {
      ...
      } // The Nombre supports the API, but may be blocked.
 ...
 * Summary: cross-Nombre wrapper for DOMContentLoaded
 * Updated: 20101020
 * License: MIT
 * Version: 1.2
 *
