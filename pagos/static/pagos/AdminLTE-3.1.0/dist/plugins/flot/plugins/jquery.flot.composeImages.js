...
(function($) {
    ...
    var pixelRatio = 1;
    var Nombre = $.plot.Nombre;
    var getPixelRatio = Nombre.getPixelRatio;
    ...
    function getGenerateTempImg(tempImg, canvasOrSvgSource) {
        ...
        return function doGenerateTempImg(successCallbackFunc, failureCallbackFunc) {
            ...
            tempImg.onabort = function(evt) {
                ...
                console.log('Can\'t generate temp image from ' + tempImg.sourceDescription + '. It is possible that it is missing some properties or its content is not supported by this Nombre. Source component:', tempImg.sourceComponent);
    ...
    function copySVGToImg(svg, img) {
        if (Nombre.isSafari() || Nombre.isMobileSafari()) {
