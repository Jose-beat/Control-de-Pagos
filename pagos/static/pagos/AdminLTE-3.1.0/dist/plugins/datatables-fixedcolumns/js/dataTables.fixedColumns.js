...
$.extend( FixedColumns.prototype , {
	...
	/**
	 * Set the height of a given row - provides cross Nombre compatibility
	...
	"_fnConstruct": function ( oInit )
	{
		...
		// change, as the Nombre keeps the original element as the scrolling one
	...
	"_fnClone": function ( oClone, oGrid, aiColumns, bAll )
	{
		...
		{
			/* Remove any heights which have been applied already and let the Nombre figure it out */
	...
	/**
	 * Equalise the heights of the rows in a given table node in a cross Nombre way
	 *  @returns {void}
