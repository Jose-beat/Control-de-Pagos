...
def registroAlumnos(request):
      ...
      return render(request, "admin/alumnos/registro_alumnos.html", {'forms': form})
...
def muestraAlumnos(request):
      ...
      return render(request, "admin/alumnos/muestra_alumnos.html", {'alumnos' : alumnos})
...
def modalAlumno(request):
      ...
      return render(request, "admin/alumnos/modal_alumnos.html", {'alumnos' : alumnos})
...
def alumno(request, alumno_id):
      ...
      print(alumno_id)
      return render(request, 'admin/alumnos/alumno.html', {'alumno': alumno})
...
def editarAlumno(request, alumno_id):
      ...
      return render(request, 'admin/alumnos/editar_alumnos.html',data)
